                    ...
                    >
                        <td className='truncate px-6 py-4 align-middle text-sm'>
                            <div className='space-y-2 p-1'>
                                <Link href={`/${projectId}/${prompt.id}/${prompt.version}`} onClick={(e) => e.stopPropagation()}>
                                    <SourceRow
                                        icon={
                                    ...
                                    <div>
                                        ...
                                        {ratings.map(({ experimentPromptId, score }, i) => (
                                            <div key={experimentPromptId} className='mt-2'>
                                                <Link
                                                    href={`/${projectId}/experiments/${experimentId}/view?experimentPromptId=${experimentPromptId}`}
                                                    prefetch={false}
                                                >
                                                    <SourceRow>
