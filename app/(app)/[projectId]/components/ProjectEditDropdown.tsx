...
export function ProjectEditDropdown({ projectName, projectId }: ProjectEditDropdownProps) {
    ...
    const { post: deleteProject, loading: deleteProjectLoading } = useFetch<DeleteResponseData>(`/${projectId}/api/delete`, {
        onError: () => toast(errorToast),
        cachePolicy: CachePolicies.NO_CACHE,
    })

    const { post: renameProject, loading: renameProjectLoading } = useFetch<RenameResponseData>(`/${projectId}/api/rename`, {
        onError: () => toast(errorToast),
        cachePolicy: CachePolicies.NO_CACHE,
    })
